...
public class MyDatabaseHelper extends SQLiteOpenHelper {
    ...
    private static String TABLE1_NAME = "EventTable";
...
//        String sql = "SELECT * FROM "+TABLE1_NAME+ " WHERE "+CONTACT_ID+"='"+contactId+"'";
    ...
    public void updateNotification(String id, String notify)
    {
        ...
        contentValues.put(KEY_ID,id);
        contentValues.put(NOTIFY,notify);
        sqLiteDatabase.update(TABLE1_NAME,contentValues,KEY_ID+" = ?",new String[]{id});
